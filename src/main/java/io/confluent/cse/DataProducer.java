...
public class DataProducer {
    ...
    public DataProducer(final Producer<String, String> producer,
                                    final String topic) {
    ...
    public static void main(String[] args) throws Exception {
        ...
        final Properties props = DataProducer.loadProperties(args[0]);
        final String topic = props.getProperty("output.topic.name");
        final Producer<String, String> producer = new KafkaProducer<>(props);
        final DataProducer producerApp = new DataProducer(producer, topic);
